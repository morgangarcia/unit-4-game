$(document).ready(function() {
  ...
  var totalScore = 0; // user's score
	...
	} // ENDs the pickRandomCrystals function

	function crystalValues(arr) {

		// changes the value of each crystal button via array
		...
		c3 = arr[2];
		c4 = arr[3];
	} // Ends the crystalValues function
	...
	$("button").on("click", function() {
		...
		if (totalScore == randNumber) {
			...
			setTimeout(function() {gameReset("Dang Son!!! SMH...YOU LOSE!")}, 200);
		}
	});
